...
function get_search_key() {
    ...
    searchButton.addEventListener('click', function() {
        ...
        if (keyField.value.trim() === '') {
            ...
            inputValue = keyField.value; // Store the value in inputValue
            ...
            for (let i = 0; i < array.length; i++) {
                ...
                if (array[i] === parseInt(inputValue)) {
                    ...
                    }, i * 500); // Change color with a delay of i * 1000 milliseconds
                    setTimeout(() => {
            ...
            // Display error message after animation completes
            setTimeout(() => {
                if (!found) {
                    errorMessage.style.color = 'rgb(203, 40, 40)';
                    errorMessage.textContent = 'Key not found!';
                }
            }, (array.length * 500) + 500); // Display error message after the last animation
        }
    });
}
